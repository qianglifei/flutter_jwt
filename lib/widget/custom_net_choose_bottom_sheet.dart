...
typedef CallBack = void Function(PoliceResponseMjxx policeman);
typedef OnTab = void Function();
class CustomNetChooseBottomSheet extends StatefulWidget{

  List<PoliceResponseMjxx> _list = [];
  String _title;
  String _pcsbm;
  CallBack callBack;
  OnTab onTab;
  CustomNetChooseBottomSheet(this._title,this._pcsbm,{this.callBack,this.onTab});
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      onTap: (){
        ...
        print(widget._pcsbm);
        DioUtils.instance.postHttps<PoliceResponseEntity>(
            ...
            onSuccess: (data){
              ...
              widget._list = data.returnData.mjxx;
              _buildDialog();
            },
            onError: (error){
              LoadingDialog.dialogDismiss(context);
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return GestureDetector(
                                      ...
                                      child: Stack(
                                        children: <Widget>[
                                          Positioned(
                                              ...
                                              child: Text(widget._list[index].mjxm,style: TextStyle(fontSize: ScreenUtil().setSp(44)))
                                          ),
                                          Positioned(
                                  ...
                                  onTap: (){
                                    ...
                                    setState(() {
                                      position = index;
                                      _selectedContent = widget._list[position].mjxm;
                                    });
